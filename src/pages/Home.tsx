...
const WHATSAPP_NUMBER = '6281384072641';
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      >
        {/* Rainbow Arc */}
        <path
          d='M20 70C20 53.4315 33.4315 40 50 40C66.5685 40 80 53.4315 80 70'
          stroke='currentColor'
          strokeWidth='6'
          strokeLinecap='round'
        />
        <path
          d='M30 70C30 58.9543 38.9543 50 50 50C61.0457 50 70 58.9543 70 70'
          stroke='currentColor'
          strokeWidth='6'
          strokeLinecap='round'
          opacity='0.6'
        />
        <path
          d='M40 70C40 64.4772 44.4772 60 50 60C55.5228 60 60 64.4772 60 70'
          stroke='currentColor'
          strokeWidth='6'
          strokeLinecap='round'
          opacity='0.3'
        ...
        {/* Crescent Moon */}
        <path
          d='M65 30C65 38.2843 58.2843 45 50 45C41.7157 45 35 38.2843 35 30C35 27.6041 35.5615 25.3387 36.5617 23.3323C31.5794 25.7501 28 30.9317 28 37C28 45.2843 34.7157 52 43 52C50.2926 52 56.3662 46.8049 57.7475 39.9572C62.1963 39.0682 65 34.9084 65 30Z'
          fill='currentColor'
        />
        {/* Star */}
        <path
          d='M55 20L56.5 24H61L57.5 26.5L59 31L55 28L51 31L52.5 26.5L49 24H53.5L55 20Z'
          fill='currentColor'
        />
      </svg>
  ...
  return (
    <section className='relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-20'>
      <motion.div style={{ y }} className='absolute inset-0 z-0'>
        ...
        <img
          src='https://images.unsplash.com/photo-1510154106653-3d0859b71c81?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      ...
      <div className='relative z-20 container mx-auto px-4 text-center text-white mt-10'>
        ...
        >
          Sempurnakan ibadah aqiqah buah hati Anda dengan hidangan istimewa,
          pelayanan profesional, dan sesuai syariat.
        </motion.p>
  ...
  const features = [
    {
      ...
      desc: 'Pemeliharaan menganut prinsip kesejahteraan hewan.',
    },
    {
      icon: 'fa-file-medical',
      title: 'Health Certificate',
      desc: 'Setiap hewan memiliki Surat Keterangan Kesehatan Hewan.',
    },
    {
      icon: 'fa-scale-balanced',
      title: 'Sesuai Syariat',
      desc: 'Penyajian dengan kaidah Aman, Sehat, Utuh, Halal.',
    },
    {
      icon: 'fa-stethoscope',
      title: 'Hewan Terawat',
      desc: 'Pemeriksaan rutin oleh Dokter Hewan profesional.',
    },
    {
      icon: 'fa-award',
      title: 'Terpercaya',
      desc: 'Dipercaya 10 tahun oleh ratusan ribu pelanggan.',
    },
    {
      icon: 'fa-shield-halal',
      title: 'Bergaransi',
      desc: 'Kami mengganti produk yang tidak sesuai standar.',
    },
    {
      icon: 'fa-gift',
      title: 'Free Gift',
      desc: 'Hadiah spesial sebagai ungkapan terima kasih.',
    },
    {
      icon: 'fa-star',
      title: 'Layanan Prima',
      desc: 'Layanan cepat, tanggap, dan standar terbaik.',
    },
  ];
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <h2 className='text-4xl md:text-5xl font-bold text-foreground mb-6'>
            Keunggulan Pelangi Aqiqah
          </h2>
          <div className='w-24 h-1 bg-primary mx-auto rounded-full mb-6'></div>
          <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
            Kami berkomitmen memberikan layanan aqiqah terbaik yang mengutamakan
            syariat, kualitas, dan kebersihan.
          </p>
        </div>
    ...
    <section id='layanan' className='py-24 bg-secondary/30'>
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <div className='w-24 h-1 bg-primary mx-auto rounded-full mb-6'></div>
          <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
            Berbagai pilihan paket aqiqah lengkap, higienis, dan sesuai syariat
            ...
            >
              ...
              <div className='p-8 flex flex-col flex-1'>
                ...
                <a
                  ...
                  target='_blank'
                  rel='noopener noreferrer'
                  className={`w-full text-center py-4 rounded-xl font-bold transition-colors ${pkg.popular ? 'bg-primary text-white hover:bg-primary/90' : 'bg-primary/10 text-primary hover:bg-primary/20'}`}
                >
                  Pesan Paket Ini
                </a>
              </div>
        ...
        <div className='text-center'>
          ...
          >
            Lihat Menu Catering Lainnya (Prasmanan, Snack & Dessert){' '}
        ...
        <div className='flex flex-col md:flex-row items-end justify-between mb-16 gap-8'>
          <div className='max-w-2xl'>
            ...
            <p className='text-muted-foreground text-lg'>
              Diolah oleh koki profesional dengan rempah pilihan, menghasilkan
              hidangan daging domba yang lezat, empuk, dan tidak prengus.
            </p>
          </div>
          <a
            href={WHATSAPP_LINK}
    ...
    <section className='py-24 bg-background relative overflow-hidden'>
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-20'>
          ...
          <h2 className='text-4xl md:text-5xl font-bold text-foreground mb-6'>
            4 Langkah Mudah Aqiqah
          </h2>
          <div className='w-24 h-1 bg-primary mx-auto rounded-full mb-6'></div>
          <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
            Proses pemesanan yang praktis, transparan, dan nyaman dari awal
            hingga pesanan tiba di rumah Anda.
          </p>
        </div>
      ...
      <div className='container mx-auto px-4 relative z-10'>
        <div className='text-center mb-16'>
          ...
          <p className='text-white/70 text-lg max-w-2xl mx-auto'>
            Kami bangga menjadi bagian dari momen bahagia keluarga Anda dalam
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <img
            ...
            alt='Feast'
            className='w-full h-80 object-cover rounded-2xl opacity-90 hover:opacity-100 transition-opacity md:col-span-2 lg:col-span-1'
          />
        </div>
          ...
          {testimonials.map((testi, i) => (
            ...
            >
              ...
              <div className='relative z-10'>
                ...
                <div>
                  <h4 className='font-bold text-foreground font-serif text-xl'>
                    {testi.name}
                  </h4>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            <div className='p-12 md:p-16 flex flex-col justify-center'>
              ...
              <p className='text-primary-foreground/80 text-lg mb-10'>
                Siap melayani kebutuhan aqiqah keluarga Anda. Konsultasikan
                paket yang sesuai dengan customer service kami.
              </p>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-lg leading-relaxed'>
                      Komplek Ruko Cimanggu Grande, RT.03/RW.15, Kedung
                      Waringin, Tanah Sereal, Kota Bogor, Jawa Barat 16164
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='mt-12'>
                ...
                >
                  <i className='fa-brands fa-whatsapp text-xl'></i> Chat
                  Customer Service
                </a>
              </div>
            </div>
    ...
    <footer className='bg-foreground text-white/70 py-16 border-t border-white/10'>
      <div className='container mx-auto px-4'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-12 mb-12'>
          <div className='col-span-1 md:col-span-2'>
            ...
            <p className='mb-6 max-w-md leading-relaxed'>
              Jasa Katering Aqiqah dan Event Muslim dengan menu terlengkap yang
              akan menjadikan moment spesial si kecil menjadi moment yang tak
              terlupakan.
            </p>
          ...
          <div>
            <h4 className='text-white font-bold mb-6 font-serif text-xl'>
              Layanan
            </h4>
        ...
        <div className='pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4'>
          <p>
            &copy; {new Date().getFullYear()} Pelangi Aqiqah. Seluruh hak cipta
            dilindungi.
          </p>
